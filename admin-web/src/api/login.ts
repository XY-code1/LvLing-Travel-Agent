...
export function forgotAdminPassword(data: { username: string; newPassword: string; captchaId: string; captchaCode: string }): Promise<null> { return apiPost<null>('/admin/forgot-password', data); }
